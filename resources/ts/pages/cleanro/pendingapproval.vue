...
import { ref } from "vue";
import approvepermit from "./Dialog-RequestcleanroPermit/approvecleanro.vue";
import rejectpermit from "./Dialog-RequestcleanroPermit/rejectcleanro.vue";
...
const getApproveRequest = ()=>{
  axios.get('/api/auth/pendinglistcleanro')
