...
import { ref } from "vue";
import approvepermit from "./Dialog-RequesthealthPermit/approvehealth.vue";
import rejectpermit from "./Dialog-RequesthealthPermit/rejecthealth.vue";
...
const getApproveRequest = ()=>{
  axios.get('/api/auth/pendinglisthealth')
